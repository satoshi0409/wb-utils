...
```
[super computer]$ singularity exec project1.sif script_wdi_xml_review_section.py
```
(1-2) review_section_master_kakenhi.xml(研究分野情報)
```
[super computer]$ singularity exec project1.sif script_wdi_xml_institution.py
```
## Project2 - DOID json
